...
admin=["ued156c86ffa56024c0acba16f7889e6d","u2d76b3ee0f0795aa93d29bdfb5f2172c","uad208d16f70d0cc48645b9f5d5909936","u5ddba0b0366f32d148979ef879edf1f0","u963f3e65aa5064e7a7eac2ff15994311"] #mamih,awil,gamar,fatimah
...
def bot(op):
    try:
        ...
        #if op.type == 13: #Di invie Admin atau Owner
            #print op.param1
            #print op.param2
            #print op.param3
            #if mid in op.param3:
