...
k3 = LINETCR.LINE() #Franky
#k3.login(qr=True)
k3.login(token="=")#8
k3.loginResult()

satpam = LINETCR.LINE() # 
satpam.login(token="")#9
...
induk=[mid]
xbots=[Cmid,Dmid]
admin=["u31ef22df7f538df1d74dc7f756ef1a32","u9cc2323f5b84f9df880c33aa9f9e3ae1","uc6a6ba43d1ce45e5c78fc7fb37afd17e","ud74066bb0bc042125f6da564f576d683","u7b8ce44a6f9d630388280e817775111f","uf1850996231087975161942c551f3ac9","u412728dbaf91158d3787b7de2aaf5be8","uaa4d57483fe9bc48d6b904dac88d8ef5","u089bf340bf8b95fd289e7db062addbed","ub15fe2438d1e5e84cc8a9d7eb17cc6ee","u76ecf3d6b5c075978ddcdd464c05ade7"]#Krisna,kris,8bot
owner=["u31ef22df7f538df1d74dc7f756ef1a32","u9cc2323f5b84f9df880c33aa9f9e3ae1","uc6a6ba43d1ce45e5c78fc7fb37afd17e","ud74066bb0bc042125f6da564f576d683","u7b8ce44a6f9d630388280e817775111f","uf1850996231087975161942c551f3ac9","u412728dbaf91158d3787b7de2aaf5be8","uaa4d57483fe9bc48d6b904dac88d8ef5","u089bf340bf8b95fd289e7db062addbed","ub15fe2438d1e5e84cc8a9d7eb17cc6ee"]
wait = {
    'contact':False,
    'autoJoin':True,
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
                    gs = ks.getGroup(msh.to)
                    gs = k1.getGroup(msh.to)
                    gs = k2.getGroup(msh.to)
                    gs = k3.getGroup(msh.to)
