...
-==================-
"""
KAC=[cl,ki,kk,kc,ks,k1,k2,k3,k4,k5,k6,k7,k8]
...
admin=["u31ef22df7f538df1d74dc7f756ef1a32","u9cc2323f5b84f9df880c33aa9f9e3ae1","ua8b707e4382fc47b4df318c7c9aa1f3e","ue1c4da54a4a2d923475769ef6ec2b270","uadfd3a23698b71d17c64482d27dc2ed1","uc3cf181e557991bec881c68483d8404f","uad6cb020c5ca7afbecb4681675eb38cd","u53c352134325f0c49e86534c57801bd7","ud5262649376cbf7576e2dcac0331d481","udcf44c4272d8209a8a5f2dd1afeea93f","u45c6ce403f0acc28392c519028aae154","udb0b6b2c1f32887d23bd3e4dfb302ed1","u0e881fcbda6a0d82974a775f8015f4fe","u0e2535e038eabba176f9181c0352f847","ue37486a841ce4944a764bf02fe730c60","u4a0be979fc73e88ebfe915bc917237b8"]#Krisna,kris,13bot
owner=["u31ef22df7f538df1d74dc7f756ef1a32","u9cc2323f5b84f9df880c33aa9f9e3ae1","ua8b707e4382fc47b4df318c7c9aa1f3e","ue1c4da54a4a2d923475769ef6ec2b270","uadfd3a23698b71d17c64482d27dc2ed1","uc3cf181e557991bec881c68483d8404f","uad6cb020c5ca7afbecb4681675eb38cd","u53c352134325f0c49e86534c57801bd7","ud5262649376cbf7576e2dcac0331d481","udcf44c4272d8209a8a5f2dd1afeea93f","u45c6ce403f0acc28392c519028aae154","udb0b6b2c1f32887d23bd3e4dfb302ed1","u0e881fcbda6a0d82974a775f8015f4fe","u0e2535e038eabba176f9181c0352f847","ue37486a841ce4944a764bf02fe730c60"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    #-------------=SC AllBio=---------------- Ganti Bio Semua Bot Format => Allbio: SUKA SUKA KALIAN :D
              ...
              if msg.from_ in owner:
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    ks.sendText(msg.to,"Bio berubah menjadi " + string + "")
                    k1.sendText(msg.to,"Bio berubah menjadi " + string + "")
                    k5.sendText(msg.to,"Bio berubah menjadi " + string + "")
                    k8.sendText(msg.to,"Bio berubah menjadi " + string + "")
    #--------------=Finish=----------------
    #--------------= SC Ganti nama Owner=--------------
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                ...
                k6.sendText(msg.to,Gmid)
                k7.sendText(msg.to,Gmid)
                k8.sendText(msg.to,Gmid)
...
#----------------------------------------------------------------------------                
            ...
            elif msg.text in ["Op rename "]:
              if msg.from_ in admin:
                string = msg.text.replace("Op rename ","")
                if len(string.decode('utf-8')) <= 20:
                    profile = cl.getProfile()
                    profile.displayName = string
                    cl.updateProfile(profile)
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            klist=[cl,ki,kk,kc,ks,k1,k2,k3,k4,k5,k6,k7,k8]
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                          if target not in Bots:
                            try:
                                klist=[ki,kk,kc,ks,k1,k2,k3,k4,k5,k6]
                                kicker=random.choice(klist)
                                kicker.kickoutFromGroup(msg.to,[target])
                                print (msg.to,[g.mid])
                            except:
        ...
        #-------------Fungsi Spam Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                kk.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                cl.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ki.sendText(msg.to,"P ��􀆶squared up!􏿿")
                kk.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                cl.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ki.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                kk.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                ...
                k3.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                k4.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                k5.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                k6.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                k7.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                k8.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                k1.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                k2.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                k3.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
                k4.sendText(msg.to,"P 􀔃􀆶squared up!􏿿")
...
#----------------------------[Spam To Contact]----------------------------#WORK 
              ...
              if msg.from_ in owner:
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(g.mid,"Ini Adalah Spam,Jangan ngintip")
                       ks.sendText(g.mid,"Ini Adalah Spam,Jangan ngintip")
                       k1.sendText(g.mid,"Ini Adalah Spam,Jangan ngintip")
                       k7.sendText(g.mid,"Ini Adalah Spam,Jangan ngintip")
                       cl.sendText(g.mid,"Ini Adalah Spam")
                       ks.sendText(g.mid,"Ini Adalah Spam")
                       k1.sendText(g.mid,"Ini Adalah Spam")
                       k7.sendText(g.mid,"Ini Adalah Spam")
                       cl.sendText(g.mid,"Ini Adalah Spam")
                       ks.sendText(g.mid,"Ini Adalah Spam")
                       k1.sendText(g.mid,"Ini Adalah Spam")
                       k7.sendText(g.mid,"Ini Adalah Spam")
                       ...
                       k1.sendText(g.mid,"Ini Adalah Spam,Jangan ngintip")
                       k7.sendText(g.mid,"Ini Adalah Spam,Jangan ngintip")
                       cl.sendText(g.mid,"Ini Adalah Spam,Masuk room")
                       ks.sendText(g.mid,"Ini Adalah Spam,Masuk room")
                       k1.sendText(g.mid,"Ini Adalah Spam,Masuk room")
                       k7.sendText(g.mid,"Ini Adalah Spam,Masuk room")
                       cl.sendText(msg.to, "Done\nTarget sudah di spam")
                       ks.sendText(msg.to, "Done\nTarget sudah di spam")
                       k1.sendText(msg.to, "Done\nTarget sudah di spam")
                       k7.sendText(msg.to, "Done\nTarget sudah di spam")
                       print " Spammed !"
#----------------------------[Spam To Contact]----------------------------#WORK 
       #--------------------Start-----------------------#       
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Saya Tukang Ngintip On")
                ki.sendText(msg.to,"Saya Tukang Nikung On")
                kk.sendText(msg.to,"Saya Tukang Mojok On")
                kc.sendText(msg.to,"Saya Tukang Baper On")
                ks.sendText(msg.to,"Saya Tukang Ngocok On")
                k1.sendText(msg.to,"Saya Tukang Ngeyel On")
                k2.sendText(msg.to,"Saya Tukang Rusuh On")
                k3.sendText(msg.to,"Saya Tukang Bully On")
                k4.sendText(msg.to,"Saya Tukang Bohong On")
                k5.sendText(msg.to,"Saya Tukang Dusta On")
                k6.sendText(msg.to,"Saya Tukang Cari Muka On")
                k7.sendText(msg.to,"Saya Tukang Merayu Orang On")
                k8.sendText(msg.to,"Saya Tukang Banyak Alasan On")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          k4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          k4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          k5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          k5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          k6.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          k6.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          k7.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          k7.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          k8.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          k8.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
          print "Like"
        except:
          pass
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    k1.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    k2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    k3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    k4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    k5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    k6.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    k7.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    k8.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By RcO-Bot😊\n\n☆º°˚˚☆One Piece Bot☆º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ by Kris ⭐👈 »»» http://line.me/ti/p/GkwfNjoPDH «««")
                    print "Like"
                except:
                    pass
            else:
    ...
    while True:
        ...
        #while a2():
            ...
            if wait["clock"] == True:
                ...
                profile5 = k6.getProfile()
                profile5.displayName = wait["cName11"]
                k6.updateProfile(profile11)
                
                profile5 = k7.getProfile()
                profile5.displayName = wait["cName12"]
                k7.updateProfile(profile12)
                
                profile5 = k8.getProfile()
                profile5.displayName = wait["cName13"]
                k8.updateProfile(profile13)
            time.sleep(600)
        except:
            pass
