...
satpam.login(token="ElhAsfzfjUzOrbE5dqUd.7rvSHV/LyctaRlOw94IEBq.htZ0W7ND5wiwKLeT1MCBkeBvSScmrhbxFfpeEVAuC6o=")
satpam.loginResult()

cl = LINETCR.LINE() #Luffy
cl.login(token="ElHijfi5d8EEw0oJg3K5.2MEDguZXZnXI+n0eT1GqXq.gTGhu3+/gdJHQirm1avx5xmW4+Q1KLyZS19cAroKU5Q=")
cl.loginResult()
...
ko.login(token="ElMmGcldrOeHLCjoSt50.A8sXP7Df+/Ovd4ui1UKIGa.YiOgT+5T+xqF7tFNVi4cI25qUNT4ZvDwCwKybGeOLdk=")
ko.loginResult()
...
ku.login(token="EmrVMU8iGygAv7VuWLTf.COZUP/ShaopYOrHcnEKKpW.Hu4uN7326ypI9JjkoZ57FBQemOj6FUSx/6YaNpvOmRA=")
ku.loginResult()
...
admin=["ued156c86ffa56024c0acba16f7889e6d","u2d76b3ee0f0795aa93d29bdfb5f2172c","uad208d16f70d0cc48645b9f5d5909936"] # Koplaxs,mamih,awil
